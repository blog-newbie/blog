            ...
            <div id="page-info"
                ...
                <ul class="pager pager-loose">
                    ...
                    <c:forEach begin="1" end="${page.pages}" var="i">
                        ...
                        <c:if test="${page.pageNum!=i}">
                            <li><a href="${ctx}/index_list?pageNum=${i}&&id=${user.id}">${i}</a></li>
                        </c:if>
                    </c:forEach>
                    ...
                    <c:if test="${page.pageNum <page.pages}">
                        <li class="previous"><a href="${ctx}/index_list?pageNum=${page.pageNum+1}&&id=${user.id}">下一页 »</a></li>
                    </c:if>
                ...
                <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
                    <div class="foot-copyrights" style="margin-left: 200px">
                        ...
                        <p>
                            ...
                            <span>邮箱：xxx@dadoudou.com</span>
                        </p>
                        <p style="margin-top: 8px">&copy;www.kyelic.囚徒 囚徒网版权所有</p>
                    </div>
                </div>
            </div>
            <!--col-md-9结束 -->
